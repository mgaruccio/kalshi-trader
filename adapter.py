...
# Register CONTRACT currency in both Cython and pyo3 backends so that
# instrument conversion during reconciliation doesn't crash with
# "ValueError: Unknown currency: CONTRACT".
_CONTRACT = Currency(
    code="CONTRACT",
    precision=0,
    iso4217=0,
